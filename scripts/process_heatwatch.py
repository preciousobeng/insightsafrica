...
COUNTRY_CITIES = {
    ...
    "ivorycoast": {
        "abidjan": {"name": "Abidjan", "region": "Lagunes",
                    "bbox": [-4.30, 5.15, -3.70, 5.60]},
        "bouake":  {"name": "Bouaké",  "region": "Vallée du Bandama",
                    "bbox": [-5.30, 7.50, -4.80, 7.90]},
        "korhogo": {"name": "Korhogo", "region": "Savanes",
                    "bbox": [-5.90, 9.20, -5.40, 9.70]},
    },
    "senegal": {
        "dakar":       {"name": "Dakar",       "region": "Dakar",
                        "bbox": [-17.60, 14.55, -17.10, 14.85]},
        "saint_louis": {"name": "Saint-Louis", "region": "Saint-Louis",
