...
NIGERIA_SITES = [
    # Artisanal mining — northern Nigeria
    {
        ...
        "region":   "Zamfara",
        "category": "artisanal",
        "bbox":     [6.268, 11.8, 7.225, 12.5],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [6.5, 12.15],
    ...
    },
    {
        ...
        "region":   "Nasarawa",
        "category": "artisanal",
        "bbox":     [8.12, 8.2, 8.82, 8.8],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [8.15, 8.5],
    ...
    },
    {
        ...
        "region":   "Plateau",
        "category": "artisanal",
        "bbox":     [8.359, 9.891, 9.059, 10.691],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [8.95, 9.9],
    ...
    },
    {
        ...
        "region":   "Kaduna",
        "category": "artisanal",
        "bbox":     [7.2, 9.887, 7.9, 10.787],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [7.55, 9.95],
...
IVORYCOAST_SITES = [
    {
        ...
        "region":   "Hambol",
        "category": "industrial",
        "bbox":     [-6.242, 9.15, -5.792, 9.6],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [-6.125, 9.375],
    ...
    },
    {
        ...
        "region":   "Worodougou",
        "category": "industrial",
        "bbox":     [-6.86, 7.648, -6.44, 8.108],   # shifted onto single tile (was partial-coverage sliver),
        "centre":   [-6.650, 7.940],
...
SENEGAL_SITES = [
    {
        ...
        "region":   "Kédougou",
        "category": "industrial",
        "bbox":     [-12.2, 12.579, -11.8, 12.899],   # shifted onto single tile (was partial-coverage sliver),
    ...
    },
    {
        ...
        "region":   "Kédougou",
        "category": "artisanal",
        "bbox":     [-12.629, 12.228, -12.179, 12.628],   # shifted onto single tile (was partial-coverage sliver),
