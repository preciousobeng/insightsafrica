...
def main():
    ...
    processed_dir = NIGERIA_DIR if args.country == "nigeria" else PROCESSED_DIR
    sites_filename = "nigeria_mining_sites.json" if args.country == "nigeria" else "galamsey_sites.json"
