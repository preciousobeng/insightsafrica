...
# Ghana:      h17v07 + h17v08 (single column, CIV-adjacent)
# Nigeria:    h17v07/h17v08 + h18v07/h18v08 — 2×2 mosaic (east)
# Ivory Coast: h16v07/h16v08 + h17v07/h17v08 — 2×2 mosaic (west)
COUNTRY_TILES = {
    "ghana":      ["h17v07", "h17v08"],
...
FARMING_REGIONS = {
    ...
    "ivorycoast": [
        {"name": "Cocoa/Coffee Belt",        "bbox": [-7.5, 4.3, -4.0,  7.0]},
        {"name": "Vallée du Bandama",         "bbox": [-5.5, 6.0, -4.0,  9.5]},
        {"name": "Sassandra-Marahoué",        "bbox": [-7.0, 6.0, -5.5,  8.5]},
        {"name": "Savanes (North)",           "bbox": [-6.5, 9.5, -3.5, 10.8]},
        {"name": "Denguélé / Grand Ouest",   "bbox": [-8.5, 7.5, -7.0, 10.0]},
    ],
    "senegal": [
        {"name": "Groundnut Basin (Kaolack-Kaffrine)", "bbox": [-16.5, 13.5, -14.0, 14.8]},
